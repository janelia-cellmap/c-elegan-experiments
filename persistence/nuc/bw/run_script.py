#%%
data_path = "/nrs/cellmap/data/jrc_c-elegans-bw-1/jrc_c-elegans-bw-1.zarr/recon-1/em/fibsem-int16/s3"
checkpoint = "/groups/cellmap/cellmap/zouinkhim/c-elegen/v2/train/fly_run/nuc/run01_32/continue/model_checkpoint_12000"
output_path = "/nrs/cellmap/zouinkhim/c-elegan/predictions/jrc_c-elegans-bw-1_result.zarr/nuc_32"
channels = ['nuc']
res = (32,32,32)
run_name = "nuc_32"
#%%
